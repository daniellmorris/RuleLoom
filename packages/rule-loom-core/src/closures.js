...
export function coreAssignClosure() {
    return {
        name: 'core.assign',
...
export function coreRespondClosure() {
    return {
        name: 'core.respond',
        handler: async (state, context) => {
            const params = context.parameters ?? {};
...
export function coreLogClosure() {
    return {
        name: 'core.log',
        handler: async (_state, context) => {
            ...
            const logger = context.runtime.logger;
            const loggerFn = logger && typeof logger[level] === 'function' ? logger[level] : undefined;
            const logFn = (loggerFn ?? console.log.bind(console));
...
export function coreTruthyClosure() {
    return {
        name: 'core.truthy',
        handler: async (_state, context) => {
...
export function coreEqualsClosure() {
    return {
        name: 'core.equals',
        handler: async (_state, context) => {
...
export function coreGreaterThanClosure() {
    return {
...
export function coreLessThanClosure() {
    return {
        name: 'core.less-than',
        handler: async (_state, context) => {
            const left = Number(context.parameters?.left);
...
export function coreIncludesClosure() {
    return {
        name: 'core.includes',
        handler: async (_state, context) => {
...
export function coreLengthClosure() {
    return {
        name: 'core.length',
        handler: async (state, context) => {
            const targetPath = context.parameters?.target;
...
export function coreForEachClosure() {
    return {
        name: 'core.for-each',
        functionalParams: [{ name: 'steps', mode: 'array' }],
        handler: async (state, context) => {
            const items = context.parameters?.collection;
            const steps = context.parameters?.steps;
...
export function createCoreClosures() {
    return [
        coreAssignClosure(),
        coreRespondClosure(),
        coreLogClosure(),
